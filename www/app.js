...
var bgOptions = {
  ...
  syncUrl: 'http://192.168.81.15/sync',
  syncThreshold: 100,
  pauseLocationUpdates: false,
  saveBatteryOnBackground: false,
  maxLocations: 100,
  url: "http://192.168.52.52:3000/background",
  method: "POST",
...
$$('[data-page="settings"]').on('keyup keydown change', '[data-type="config"]', function(ev) {
  ...
  alert('changed'+" "+ this.name+" "+ this.checked+" "+ this.value);
...
function setCurrentLocation (location) {
    ...
    // $.post( "http://localhost/test", { latitude: location.latitude, longitude: location.longitude, speed: location.speed });
    console.error("enviando datos");
